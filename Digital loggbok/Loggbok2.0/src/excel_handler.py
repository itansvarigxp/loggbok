...
statistics_categories = OrderedDict([('Datum', StatLogger.yesterday),
                         ...
                         ('Totalt antal timmar i verkstaden idag', StatLogger.totalTimeToday.strftime("%H:%M:%S")),
                         ('Styret antal timmar i verkstaden idag', StatLogger.totalTimeTodayStyret.strftime("%H:%M:%S")),
                         ('Totalt antal timmar i verkstaden denna månad', StatLogger.totalTimeMonth.strftime("%H:%M:%S")),
                         ('Styret antal timmar i verkstaden denna månad', StatLogger.totalTimeMonthStyret.strftime("%H:%M:%S")),
                         ('Antal incheckningar totalt idag', StatLogger.checkinsToday),
                         ('Genomsnittlig daglig verksamhet', StatLogger.dailyMean.strftime("%H:%M:%S")),
                         ('Standardavvikelse', StatLogger.dailyStdDev.strftime("%H:%M:%S")),
                         ('Genomsnittlig tid i verkstaden', StatLogger.monthlyMean.strftime("%H:%M:%S")),
                         ('Standardavvikelse', StatLogger.monthlyStdDev.strftime("%H:%M:%S")),
                         ('Styret genomsnittlig tid i verkstaden', StatLogger.monthlyMeanStyret.strftime("%H:%M:%S")),
                         ('Styret Standardavvikelse', StatLogger.monthlyStdDevStyret.strftime("%H:%M:%S")),
